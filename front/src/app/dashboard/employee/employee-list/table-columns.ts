...
export const employeeColumns: ColumnModel[] = [
    { apiValue: '_id', type: ColumnModelTypes.id, value: 'Folio' },
    { apiValue: 'employee_number', type: ColumnModelTypes.string, value: 'Numero de Empleado' },
    ...
    { apiValue: 'active', type: ColumnModelTypes.boolean, value: 'Activo' },
